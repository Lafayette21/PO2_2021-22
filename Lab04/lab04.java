//Proszę zaimplementować klasę lab4string
...
public class lab04
{
 public static void main(String[] args)
 {
  ...
  boolean palindrom = lab4string.czy_plaindrom("otto");
  if (palindrom == true) punkty = punkty + 0.5;
  System.out.println("czy_plaindrom(\"otto\") = " + palindrom);  
  
  palindrom = lab4string.czy_plaindrom("kot");
  ...
  boolean abecadlowe = lab4string.czy_abecadlowe("abcdef");
  if (abecadlowe == true) punkty = punkty + 0.5;
  System.out.println("czy_abecadlowe(\"abcdef\") = " + abecadlowe);  
  
  abecadlowe = lab4string.czy_abecadlowe("zebra");
  ...
  System.out.println(lab4string.rot13("Why did the chicken cross the road?"));
  System.out.println(lab4string.rot13("Gb trg gb gur bgure fvqr!"));
